...
[![npm version](https://badge.fury.io/js/lightbox-js.svg)](https://www.npmjs.com/package/lightbox-js)
...
```javascript
const { js, batch } = require('lightbox-js');
